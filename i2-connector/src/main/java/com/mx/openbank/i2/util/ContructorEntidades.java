...
public class ContructorEntidades {
	...
	public Map<String, Object> mapeoEntidadPersona(Persona dataPersona) {
		...
		entity.put("id", dataPersona.getCustomerId());
		properties.put("TP1", dataPersona.getFirstName());
		properties.put("TP2", dataPersona.getLastNames());
		properties.put("TP3", dataPersona.getStatusRiesgo());
		properties.put("TP5", dataPersona.getCustomerId());
        properties.put("TP6", dataPersona.getPep());
//		properties.put("TP51", dataPersona.getIndicadorEmpleado());
	...
	public Map<String, Object> mapeoEntidadDomicilio(Domicilio dataDomiclio) {
		...
		entity.put("version", 1);
		entity.put("id", dataDomiclio.getId() + "|"+ dataDomiclio.getCalle() + "|" + dataDomiclio.getCiudad()+ "|" + dataDomiclio.getCp() + "|" + dataDomiclio.getPais() + "|" + dataDomiclio.getEstado());
		...
		properties.put("TP24", dataDomiclio.getId() + "|"+ dataDomiclio.getCalle() + "|" + dataDomiclio.getCiudad()+ "|" + dataDomiclio.getCp() + "|" + dataDomiclio.getPais() + "|" + dataDomiclio.getEstado());
		entity.put("properties", properties);
...
//		entity.put("properties", properties);
	...
	public Map<String, Object> mapeoEntidadOnboarding(Onboarding dataOnboarding) {
		UtilConnector util = new UtilConnector();
	    Map<String, Object> entity = new HashMap<>();
	    Map<String, String> properties = new HashMap<>();
	    entity.put("typeId", "TENT5");
	    entity.put("version", 1);
	    entity.put("id",  dataOnboarding.getId());
	    properties.put("TP26", util.toIsoDateTime(dataOnboarding.getFechaHora()));
	    properties.put("TP28", "Onboarding: "+dataOnboarding.getId());
...
//		properties.put("TP34", dataOperacion.getCoordenadas());
	...
	public Map<String, Object> mapeoEntidadCuenta(Cuenta dataCuenta) {
		...
		entity.put("version", 1);
		entity.put("id", dataCuenta.getAccountId());
		properties.put("TP9", dataCuenta.getAccountCode());
		properties.put("TP10", dataCuenta.getAccountType());
//		properties.put("TP11", dataPersona.getIdCliente());
		properties.put("TP54", dataCuenta.getIdCuenta());

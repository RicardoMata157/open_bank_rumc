...
public class ConfigDataBases {
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:postgresql://10.1.4.142:5432/openBanckDumy"); // modifica la url y el usuario del ambiente de aurora openbank
	...
	private Map<String, Object> properties() {
		...
		jpaProperties.put(AvailableSettings.HBM2DDL_AUTO, "none"); // se cambia dependiendo a la necesidad modificar a
